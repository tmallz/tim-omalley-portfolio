  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href = "{base}/my-work">My Work</a></li>
        <li><a href = "{base}/resume/resume-redacted.pdf" download>Resume</a></li>
        <li><a href="#my-modal">Contact Me</a></li>
      </ul>
    </div>
    <div class="flex">
      <a href = "{base}/" class="btn btn-ghost normal-case text-xl">Tim O'Malley Portfolio</a>
...
<div class="modal" id="my-modal">
  <div class="modal-box">
    <h3 class="font-bold text-lg">See Contact Information Below</h3>
    <p>I am always open to hearing about new work opportunites, feel free to contact me at any time and I will get back to you as soon as possible</p>
    <p class="py-4">Phone: 630-379-7358</p>
    <p class="py-4">Email: <a href="mailto:tomalley24@gmail.com">tomalley24@gmail.com</a></p>
